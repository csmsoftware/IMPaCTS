...
<pre>
  ...
  input:
       ...
       opt: a struct to store parsing options, opt can be replaced by 
            ...
            opt.NameIsString [0|1]: for UBJSON spectraification Draft 8 or
...
# loadubjson can not parse all UBJSON spectraification (Draft 9) compliant \
